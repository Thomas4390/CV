...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems}
        \item{\textbf{Mémoire:} Gamma Exposure and Intraday Volatility Dynamics in the SPX Options Market. Cartographie des changements de régime de la surface de vol intraday induits par le dealer hedging à partir de données d'options aux 5 minutes (2B+ points de données, août 2020--juil. 2025).}
        \item{\textbf{Moyenne:} 3.88/4.3. Récipiendaire des bourses d'excellence \textbf{Deloitte M.Sc.}, \textbf{Alpha Fixe Capital}, \textbf{Jocelyne \& Jean C. Monty I} et \textbf{Jocelyne \& Jean C. Monty II} pour l'excellence académique.}
        \item{\textbf{Hackathons:} Équipe gagnante du défi Banque Nationale au ConUHacks VIII 2024 (1000+ participants). Top 10 finaliste au McGill FIAM Portfolio Management Hackathon (66 équipes). 2e place à la compétition de Trading du Club de Trading HEC Montréal.}
